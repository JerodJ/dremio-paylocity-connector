...
@SourceType(value = "PaylocityARP", label = "Paylocity",uiConfig = "paylocity-layout.json")
public class PaylocityConf extends AbstractArpConf<PaylocityConf> {
  private static final String ARP_FILENAME = "arp/implementation/paylocity-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.paylocity.PaylocityDriver";
